...
-- Run this in your Supabase SQL Editor to create fresh tables
...
INSERT INTO auth_users (email, username, password, bio) VALUES
(
    'admin@blog.com',
    'admin',
    'password123',
...
BEGIN
    ...
    -- Insert sample blog posts with the sample user as author
